...
# 压缩dump
# 7z a -t7z -m0=lzma2 -mx=9 -mfb=273 -md=512m -ms=on -mmt=on -mtc=off -mta=off /workspace/dumps.7z /root/.local/share/PrismLauncher/instances/GT_New_Horizons_2.8.4_Java_17-25/.minecraft/dumps/