...
public final class ImageUtils {
    ...
    static final int ALPHA_THRESHOLD = 220;
    static final int TOLERANCE_R = 3;
    static final int TOLERANCE_G = 2;
    static final int TOLERANCE_B = 5;
    ...
    public static BufferedImage loadImage(File file) throws IOException {
        ...
        if (img == null) {
            throw new IOException("not a decodable image: " + file);
        }
        return img;
    }
     ...
     * <li>同一列中颜色相近（R&lt;30、G&lt;20、B&lt;50 容差）的连续像素合并为一个竖条形状，
     * alpha &le; 220 视为透明不生成形状。
     * </ul>
     *
