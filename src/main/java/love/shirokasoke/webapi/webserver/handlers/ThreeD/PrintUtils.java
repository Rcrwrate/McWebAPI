...
import love.shirokasoke.webapi.config.OCConfig;
...
public final class PrintUtils {
    ...
    static final int ALPHA_THRESHOLD = OCConfig.print.alphaThreshold;
    static final int TOLERANCE_R = OCConfig.print.toleranceR;
    static final int TOLERANCE_G = OCConfig.print.toleranceG;
    static final int TOLERANCE_B = OCConfig.print.toleranceB;
     ...
     * <li>颜色相近（容差见 {@link OCConfig.Print#toleranceR}/{@link OCConfig.Print#toleranceG}/
     * {@link OCConfig.Print#toleranceB}） 的相邻像素按二维贪心合并为矩形形状，alpha &le;
     * {@link OCConfig.Print#alphaThreshold} 视为透明不生成形状。
     * </ul>
     *
