...
export default function ColorSetting() {
    ...
    return <ThemeProvider theme={theme}>
        <Grid container sx={{ color: "text.primary", textAlign: "center", p: 2, justifyContent: "center", alignItems: "stretch" }} spacing={2}>
            <Grid size={{ xs: 6, md: 8 }}>
                <p>温馨提示</p>
                <p>日夜主题配色需要分别修改和保存</p>
                <p>如果配置没有成功载入，请手动点击重载</p>
                <p>右边是您主题配置的预览</p>
                <Stack sx={{ m: 1, justifyContent: "center", flexWrap: "wrap" }} direction="row" spacing={2} useFlexGap >
